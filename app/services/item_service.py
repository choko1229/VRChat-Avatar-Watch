...
def sale_items(db: Session, limit: int = 12, sort: str | None = None) -> list[Item]:
...
def free_items(db: Session, limit: int = 12, sort: str | None = None) -> list[Item]:
...
def tool_items(db: Session, limit: int = 40, sort: str | None = None) -> list[Item]:
