...
def item_detail(request: Request, item_id: int, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request, "items/detail.html", {"item": item, "related_items": related, "user": current_user(request, db)})
...
def me(request: Request, db: Session = Depends(get_db)):
    return templates.TemplateResponse(request, "me.html", {"user": current_user(request, db)})
